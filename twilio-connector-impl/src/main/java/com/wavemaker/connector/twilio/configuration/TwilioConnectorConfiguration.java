package com.wavemaker.connector.twilio.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.wavemaker.connector.twilio")
public class TwilioConnectorConfiguration extends ConnectorConfigurationBase {
